...
for nomean in range(1):
    ...
    mp.plot(x,y2_recycle,'x--',color='black',label='Pure NE strategy with resource recovery',linewidth=1)
    ...
    mp.savefig("..\..\仿真报告\批注修改图-衰落\功率变量-平均有效回程速率.png", dpi=750, bbox_inches = 'tight')
