...
for nomean in range(1):
    ...
    for i in range(x_times):
        ...
        y1_extra.append(temp[4]*8/1000000/U_sum)
        y2_extra.append(temp[5]*8/1000000/U_sum)
        y2_recycle_extra.append(temp[6]*8/1000000/U_sum)
        y3_extra.append(temp[7]*8/1000000/U_sum)
        U_sum += 5
    y1=np.array(y1)
    y2=np.array(y2)
    ...
    mp.savefig("..\..\仿真报告\批注修改图-衰落\无人机数目变量-平均有效回程速率2.png", dpi=300, bbox_inches = 'tight')
